...
// At least this many embedding rows must be available before OpenMP parallel execution is considered.
...
// is sufficiently large to offset thread scheduling and synchronization overhead.
