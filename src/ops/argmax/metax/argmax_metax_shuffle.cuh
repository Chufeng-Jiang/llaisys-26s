...
ArgmaxResult warp_reduce_argmax_shuffle64(
	ArgmaxResult result
) {
...
#pragma unroll
	for (
		...
		if (
			other_index
			!= cuda_compat::ARGMAX_INVALID_INDEX
		) {
...
__device__ __forceinline__
ArgmaxResult block_reduce_argmax_shuffle64(
...
>
__global__
void argmax_multiblock_shuffle_stage1_kernel(
...
>
__global__
void argmax_multiblock_shuffle_stage2_kernel(
...
>
inline
void launch_argmax_multiblock_shuffle_fixed(
	std::int64_t *max_idx,
	T *max_val,
	const T *vals,
	std::size_t numel,
	...
	argmax_multiblock_shuffle_stage1_kernel<
		T,
		BLOCK_SIZE
	>
		<<<
	...
	argmax_multiblock_shuffle_stage2_kernel<
		T,
		BLOCK_SIZE
	>
		<<<
...
template <typename T>
inline
void launch_argmax_multiblock_shuffle(
	std::int64_t *max_idx,
	T *max_val,
	const T *vals,
	std::size_t numel,
	...
	case 64:
		return
			launch_argmax_multiblock_shuffle_fixed<
				T,
				64
			>(
				max_idx,
