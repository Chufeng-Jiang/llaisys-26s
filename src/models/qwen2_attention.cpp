...
llaisys::tensor_t qwen2_attention_forward(
	...
	auto projected_attention =
		workspace.get(
			Qwen2WorkspaceSlot::AttentionProjection,
			{
				sequence_length,
				hidden_size
			},
	...
	auto attention_residual =
		workspace.get(
			Qwen2WorkspaceSlot::AttentionResidual,
			{
				sequence_length,
				hidden_size
			},
