...
print("LLAISYS runtime stream:", hex(stream_ptr))

assert stream_ptr != 0


external_stream = torch.cuda.ExternalStream(stream_ptr, device=0)

print("PyTorch external stream:", hex(external_stream.cuda_stream))
