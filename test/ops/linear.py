...
def test_op_linear(
    out_shape, x_shape, w_shape, use_bias=True, dtype_name="f32", atol=1e-5, rtol=1e-5, device_name="cpu", profile=False
):
    ...
    if profile:
        benchmark(lambda: torch_linear(out, x, w, bias), lambda: llaisys.Ops.linear(out_, x_, w_, bias_), device_name)
...
if __name__ == "__main__":
    ...
    #
    # Tiny:
    #     validates row-major mapping and bias.
    #
    # Decode-like:
    #     M = 1.
    #
    ...
    #     M = 512.
    #
    # Both bias and no-bias paths are covered.
    # ========================================================
