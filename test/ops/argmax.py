...
def test_op_argmax(shape, dtype_name="f32", device_name="cpu", profile=False):
    ...
    assert check_equal(max_val_, max_val, strict=True) or check_equal(max_idx_, max_idx, strict=True)
