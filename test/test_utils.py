...
def benchmark(torch_func, llaisys_func, device_name, warmup=10, repeat=100, rounds=10):
    llaisys_stats = benchmark_llaisys(llaisys_func, device_name, warmup=warmup, repeat=repeat, rounds=rounds)
